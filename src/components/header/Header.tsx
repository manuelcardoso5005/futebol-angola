...
const Header: React.FC = () => {
    return (
        <header className='leading-[1.6] bg-gradient-to-br from-[#0d0d0d] via-[#1a1a1a] to-[#2d2d2d] px-8 py-3 shadow-[0_4px_12px_rgba(0,0,0,0.15)] sticky top-0 z-[1000]'>
            <nav className="nav-area flex justify-between items-center max-w-[1400px] mx-auto ">
                <div className="logo text-white text-[1.8rem] font-bold tracking-[1px] uppercase [text-shadow:2px_2px_4px_rgba(0,0,0,0.3)] transition-transform duration-300 ease-in-out hover:scale-105">
                    Scouting Angola
                </div>
                <ul className="flex list-none gap-[1.8rem] menu">
